...
// It hides every other screen and shows only the target.
// It highlights the correct nav button and hides the nav bar entirely on setup.
...
// linking each nav button so clicking it navigates to the screen linked with it 
navItems.forEach((btn) => {
...
// ─────────────────────────────────────────────
// LOGIN FORM
// Verify credentials via the API and send them to the PIN lock screen.
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// PIN UNLOCK FORM
// The user enters their PIN to actually get into the app.
// Fetches fresh data from the database upon success.
// ─────────────────────────────────────────────
...
// Highlights the clicked button and stores its value.
// ─────────────────────────────────────────────
...
// budget period. Sends data to the backend API.
// ─────────────────────────────────────────────
...
// ─────────────────────────────────────────────
// LOG EXPENSE FORM
// Send the new expense to the backend database,
// then sync to update the UI.
// ─────────────────────────────────────────────
...
// Tries to silently log the user back in using a saved session.
// ─────────────────────────────────────────────
async function fk() {
